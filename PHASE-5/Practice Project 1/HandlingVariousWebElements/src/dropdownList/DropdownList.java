...
//retrieves the "selected" status of the dropdown element.
		System.out
				.println("The Output of the IsSelected " + driver.findElement(By.id("student_subjects")).isSelected());
		// retrieves the "enabled" status of the dropdown element.
		System.out.println("The Output of the IsEnabled " + driver.findElement(By.id("student_subjects")).isEnabled());
		// retrieves the "displayed" status of the dropdown element.
		System.out.println(
				"The Output of the IsDisplayed " + driver.findElement(By.id("student_subjects")).isDisplayed());
		// retrieves the size (width and height) of the dropdown element.
		System.out.println("The Output of the Size " + driver.findElement(By.id("student_subjects")).getSize());
